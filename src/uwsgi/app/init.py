...
def init():
    ...
    sql.execute(
        "CREATE TABLE notes (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, title VARCHAR (30) NOT NULL, body VARCHAR(1000) NOT NULL, owner VARCHAR(32));")
    ...
    sql.execute(
        f"INSERT INTO users (email, name, surname, username, password) VALUES (\'admaskij@gmail.com\', \'Jan\', \'Adamski\', \'admin\', \'$2b$14$cON4hh1yS4WGQ0aIbK.X.uw754.6ZN6p3DUsvIxb9/LUKQgRQoANO\');")
    db.commit()
