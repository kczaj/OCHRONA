...
def init():
    ...
    sql.execute("CREATE TABLE notes (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, title VARCHAR (30) NOT NULL, body VARCHAR(1000) NOT NULL, owner VARCHAR(32), password VARCHAR(150) NOT NULL);")
